					...
					<div id="option1">
						...
						<div id="option2">
							...
							<select name="intersect07" class="input-spanall intersect seclist">
								...
								<option value="0401232F1">ทางแยกต่างระดับชลบุรี ถนนฝั่งขาเข้า ชลบุรี-บ้านบึง</option>
								<option value="0401214F1">ทางแยกต่างระดับชลบุรี ถนนฝั่งขาออก กรุงเทพ-ชลบุรี </option>
